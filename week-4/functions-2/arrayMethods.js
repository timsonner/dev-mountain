...
const myStrongest = monstersInYourPocket.filter(element => element.CP > 200) // filter returns true or false based on condition
console.log(`myStrongest:`)
console.table(myStrongest)
...
const orderTotals = orders.map(element => (element.price * (1 + element.tax)).toFixed(2))
...
const purchasesFilteredByBob = purchases.filter(element => element.owner === "Bob")
console.log(`purchasesFilteredByBob:`)
console.table(purchasesFilteredByBob)
const bobsPurchasesMappedByPrice = purchasesFilteredByBob.map(element => element.price)
console.log(`bobsPurchasesMappedByPrice:`)
console.table(bobsPurchasesMappedByPrice)
const bobsTotal = bobsPurchasesMappedByPrice.reduce((previousValue, currentValue) => previousValue + currentValue,
0)
