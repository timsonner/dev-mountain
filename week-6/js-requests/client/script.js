...
sayHelloButton.classList.add("black-bg-white-text")
// console.log(`🟢 changeButtonColor triggered`)
...
// CODE HERE
const revertButtonColor = (event) => {
    sayHelloButton.classList.add("button-default-color")
}
...
// CODE HERE
const getQueryTest = () => {
    // empy query returns "you sent an empty query"
axios.get("http://localhost:3000/query-test/?q=123").then((res) => {
    // axios.get("http://localhost:3000/query-test/?q=abc/?d=123").then((res) => {

console.log(res.data)
})
}
document.getElementById("query-button").addEventListener("click", getQueryTest)
