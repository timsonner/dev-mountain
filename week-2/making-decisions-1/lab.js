...
console.log(`One should wear a rain-jacket.`)
  ...
  console.log(`One should wear a flourescent green and pink Obermeyer ski suit from 1992.`)
  } else if (temperature >= 60 && temperature<= 80 && rain == false) {
  console.log(`One should wear a rabid porcupine.`)
  } else if (temperature <= 60 && rain == false) {
    console.log(`One should wear a Charles Dickens novel to show off one's sophistication and taste in excellent literature.`)
  }
////////// PROBLEM 5 //////////
...
while (z > 0) {
  ...
  z-- // for loop finished, decrement z
}