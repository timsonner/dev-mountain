...
const analysisOfRequirements = `Breaks down the project into micro systems, for the purpose of analyzing project goals, focusing on what needs to be created, and allows engagement of users to understand project requirements `
const design = ``
