...
import { fetchInspireQuotes } from './controller.js'
import { fetchProgramQuotes} from './controller.js'
...
app.get('/api/quote/inspire', fetchInspireQuotes)
app.get('/api/quote/program', fetchProgramQuotes)
